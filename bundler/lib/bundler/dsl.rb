        ...
        if current.requirement != dep.requirement
          ...
          if current.type == :development
            ...
            unless current_requirement_open || dep.type == :development
              Bundler.ui.warn "A gemspec development dependency (#{dep.name}, #{current.requirement}) is being overriden by a Gemfile dependency (#{dep.name}, #{dep.requirement}).\n" \
                              "Please remove either of them, or make sure they both have the same requirement\n" \
            end
          else
            update_prompt = ""
